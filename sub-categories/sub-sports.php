...
<!-- sub categories grid -->
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="col-lg-12">
                <h1 class="page-header">Sports Goods
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h4>Hunting & Fishing</h4>
                <a href="sub-view/sports/search-hunting.php">
                    <img class="img-responsive" src="sports\hunting.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Running</h4>
                <a href="sub-view/sports/search-running.php">
                    <img class="img-responsive" src="sports\running.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Outdoor Pitch Sports</h4>
                <a href="sub-view/sports/search-pitch-sport.php">
                    <img class="img-responsive" src="sports\football.jpg" alt="">
                </a>
            </div>
          
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Cycling</h4>
                <a href="sub-view/sports/search-cycling.php">
                    <img class="img-responsive" src="sports\cycling.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Climbing</h4>
                <a href="sub-view/sports/search-climbing.php">
                    <img class="img-responsive" src="sports\climbing.jpg" alt="">
                </a>
            </div>
        </div>
        <!-- /.row -->
