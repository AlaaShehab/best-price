...
<!-- sub categories grid -->
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="col-lg-12">
                <h1 class="page-header">Furniture
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h4>Bedroom</h4>
                <a href="sub-view/furniture/search-bedroom.php">
                    <img class="img-responsive" src="furniture\bedroom.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Living room</h4>
                <a href="sub-view/furniture/search-livingroom.php">
                    <img class="img-responsive" src="furniture\living-room.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Kitchen & Dining room</h4>
                <a href="sub-view/furniture/search-kitchen.php#">
                    <img class="img-responsive" src="furniture\kitchen.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Office Furniture</h4>
                <a href="sub-view/furniture/search-office.php">
                    <img class="img-responsive" src="furniture\office.png" alt="">
                </a>
            </div>
