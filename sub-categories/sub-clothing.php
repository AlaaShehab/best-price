...
<!-- sub categories grid -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h4>Athletic clothing</h4>
                <a href="sub-view/clothing/search-athletic.php">
                    <img class="img-responsive" src="clothing\athletic.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Men</h4>
                <a href="sub-view/clothing/search-men.php">
                    <img class="img-responsive" src="clothing\men.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Women</h4>
                <a href="sub-view/clothing/search-women.php">
                    <img class="img-responsive" src="clothing\women.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Boys</h4>
                <a href="sub-view/clothing/search-boys.php">
                    <img class="img-responsive" src="clothing\boys.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Girls</h4>
                <a href="sub-view/clothing/search-girls.php">
                    <img class="img-responsive" src="clothing\girls.jpg" alt="">
                </a>
            </div>
