...
<!-- sub categories grid -->
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="col-lg-12">
                <h1 class="page-header">Beauty & Health
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h4>Accessories</h4>
                <a href="sub-view/beauty-health/search-accessories.php">
                    <img class="img-responsive" src="beauty-health\accessories.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Natural herbs</h4>
                <a href="sub-view/beauty-health/search-herbs.php">
                    <img class="img-responsive" src="beauty-health\beauty-spa.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Household & Babycare</h4>
                <a href="sub-view/beauty-health/search-babycare.php">
                    <img class="img-responsive" src="beauty-health\babycare.jpg" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
            <h4>Luxury Beauty</h4>
                <a href="sub-view/beauty-health/search-luxury">
                    <img class="img-responsive" src="beauty-health\luxury.jpg" alt="">
                </a>
            </div>
